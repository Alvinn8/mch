...
public class ChunkDataPartStorageTests {
    @Test
    ...
    private byte[] write() throws IOException {
        ChunkDataPartStorage storage = new ChunkDataPartStorage();
    ...
    private void read(byte[] bytes) throws IOException {
        ...
        ChunkDataPartStorage storage = new ChunkDataPartStorage(input);
